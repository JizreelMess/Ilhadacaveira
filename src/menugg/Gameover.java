...
import static menugg.Rodando.pontos;
...
public class Gameover extends javax.swing.JFrame {
    ...
    public Gameover() {
        ...
        jLabel3.setText(Integer.toString(ver));
        int acerto = Rodando.acerto();
        jLabel5.setText(Integer.toString(acerto));
        int erro = Rodando.erros();
        jLabel6.setText(Integer.toString(erro));
    ...
    private void initComponents() {
        ...
        ImageIcon icon = new ImageIcon(getClass().getResource("/imagem/caveirap.gif"));
        ...
        jLabel4.setText("HAHAHAHAHA VOCÊ NÃO TEM MAIS VIDAS DISPONIVEIS ");
